...
import { validateField, validateAllFields, ValidationErrors } from '@/utils/validationUtils';
        ...
        <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-sm">
          ...
          {resetEmailSent ? (
            <div className="text-center">
              <p className="mb-4 text-green-600">Password reset email has been sent!</p>
              <button
                onClick={() => {
          ...
          {!isLogin && (
            <>
              ...
              <input
                ...
                value={phoneNumber}
                onChange={handleInputChange}
                className={`w-full p-2 border rounded ${fieldErrors.phone ? 'border-red-500' : ''}`}
                required={!isLogin}
              />
              {fieldErrors.phone && (
              ...
              <div className="space-y-2">
                <input
                  ...
                  value={street}
                  onChange={handleInputChange}
                  className={`w-full p-2 border rounded ${fieldErrors.street ? 'border-red-500' : ''}`}
                  required={!isLogin}
                />
                {fieldErrors.street && (
                ...
                <input
                  ...
                  value={postalCode}
                  onChange={handleInputChange}
                  className={`w-full p-2 border rounded ${fieldErrors.postalCode ? 'border-red-500' : ''}`}
                  required={!isLogin}
                />
